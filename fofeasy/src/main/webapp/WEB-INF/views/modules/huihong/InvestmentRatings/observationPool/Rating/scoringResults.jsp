...
<body>
	...
	<section class="fof-content Evaluation">
		<div id="scoringResults" class="row">
			<div class="col-md-12">
				<div class="topHead">
					<div class="Figure">
						<div class="circle">
					...
					<div class="txt">
						<span>客观评价</span> <span>主观评价</span> <span>评价结果</span>
					</div>
				</div>
				<div class="content">
					<div class="header">
						<span>投顾评分结果(系统默认模板)</span>
					</div>
					<!-- 得分 -->
					<div class="istanceTop20" style="height:240px;">
						<div class="pieChartDiv" id="pie1"></div>
						<div class="pieChartDiv" id="pie2"></div>
						<div class="pieChartDiv" id="pie3"></div>
						<div class="pieChartDiv" id="pie4"></div>
					</div>
					<div class="header">
						<span>评分报告(系统默认模板)</span>
					</div>
					...
					<div class="confirmPrcdiv distanceTop40">
						<a href="${ctxPage}/InvestmentRatings/observationPool/Score/subjRatingPage/"><button
								id="determineBtn" class="btn upfileBtn" type="button">上一步</button></a>
						<a href="${ctxPage}/InvestmentRatings"><button id="back" type="button">保存报告</button></a>
						<!-- <button class="btn upfileBtn" type="button">下载报告</button> -->
						<a href="${ctxPage}/InvestmentRatings"><button type="button">返回</button></a>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		require([ 'huihong/InvestmentRatings/observationPool/rating/scoringResults' ]);
	</script>
</body>
</html>