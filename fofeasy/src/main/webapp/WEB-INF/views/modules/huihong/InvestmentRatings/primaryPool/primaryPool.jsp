	...
	<div class="moduleDiv outerDiv distanceTop40">
		<div class="table-responsive">
			<table id="filterTbl" class="table ulTable">
				<tr>
					<td><span class="ultitleTxt3">关键字：</span></td>
					<td colspan="2">
				...
				<tr>
					<td><span class="ultitleTxt3">投资策略：</span></td>
				...
				<tr id="foundationYears">
					<td><span class="ultitleTxt3">成立年限：</span></td>
				...
				<tr>
					<td><span class="ultitleTxt3">投顾规模：</span></td>
				...
				<tr>
					<td><span class="ultitleTxt3">尽调状态：</span></td>
					<td class="ulContent" id="adjustState" colspan="2">
						<button data-id="13" class="checkboxBtn checkboxBtnshort"
							name="disMethod">未开始</button>
						<button data-id="12" class="checkboxBtn checkboxBtnshort"
							name="disMethod">进行中</button>
						<button data-id="12" class="checkboxBtn checkboxBtnshort"
							name="disMethod">完成</button>
					</td>
				</tr>
				<tr>
					<td><span class="ultitleTxt3">综合评级：</span></td>
				...
				<tr>
					<td><span class="ultitleTxt3">安全垫比例：</span></td>
					<td class="ulContent pad0" colspan="2">
						<div class="percent45 pull-left">
							<button data-id="12" class="checkboxBtn checkboxBtnshort"
								name="disMethod">不愿意出</button>
							<button data-id="12" class="checkboxBtn checkboxBtnshort"
								name="disMethod">不超过5%</button>
							<button data-id="12" class="checkboxBtn checkboxBtnshort"
								name="disMethod">5%-10%</button>
							<button data-id="12" class="checkboxBtn checkboxBtnshort"
								name="disMethod">大于10%</button>
						</div>
						<div class="percent55 pull-left">
							<div class="tableTitlediv">是否具有投顾资质:</div>
							<div class="padTop8">
								<button data-id="else" class="checkboxBtn checkboxBtnshort"
									name="disMethod">有</button>
								<button data-id="else" class="checkboxBtn checkboxBtnshort"
									name="disMethod">无</button>
							</div>
						</div>
					</td>
				</tr>
