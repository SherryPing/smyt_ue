			...
			<div class="row">
				<div class="col-md-12">
						...
						<div class="netCharts">
							<div class="charHeader distanceTop20" style="margin-top:20px">
									<div class="headerLeft">
										...
										<span id="main_title" class="charHeadtxt" >累计收益率</span>
										<div id="coin_title" style="display:none;float: left;width: 100%;">
											<div id="incomeSlider2" class="incomeSlider">
												<ul id="incomeUl2" class="incomeUl">
													<li data-indicator='return_10k'>万份收益</li>
													<li data-indicator='d7_return_a'>七日年化</li>
													<li class="histolineActive" style="margin-left:-220px;"></li>
												</ul><br>
											</div>
											<div id="incomeLine2" class="incomeLine"></div>
										</div>
									</div>
						...
						<div class="infoTitle distanceTop0" id="rankingTitle">
							<div class="introducTitle"></div>
							<div class="titleTxt">
								<span id="rankName">同类排名</span>
								<span id="rank_date" class="black mleft20"></span>
							</div>
						</div>
						...
						<div class="infoTitle">
							...
							<div class="titleTxt">
								<span>收益指标</span>
								<span id="income_date" class="black mleft20"></span>
							</div>
						</div>
									...
									<div class="charHeader">
										...
										<div class="chartRightcnt">
											...
											<div>
												...
												<div id = 'return_pe_div' class="productName">本基金</div>
												<div>正收益期数</div>
											</div>
											<%--<div>--%>
						...
						<div class="infoTitle distanceTop0">
							...
							<div class="titleTxt">
								<span>风险指标</span>
								<span id="risk_date" class="black mleft20"></span>
							</div>
						</div>
						<div class="indicatorsContent">
							<!-- 风险指标表 -->
						...
						<div class="infoTitle distanceTop0">
							...
							<div class="titleTxt">
								<span>风险调整收益指标</span>
								<span id="riskAdjust_date" class="black mleft20"></span>
							</div>
						</div>
						<div class="indicatorsContent">
							<!-- 风险调整收益指标表 -->
						...
						<div class="infoTitle distanceTop0">
							...
							<div class="titleTxt">
								<span>相对指标</span>
								<span id="relative_date" class="black mleft20"></span>
							</div>
						</div>
						<div class="indicatorsContent">
