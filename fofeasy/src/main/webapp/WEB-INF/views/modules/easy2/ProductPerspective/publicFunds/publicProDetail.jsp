	...
	<div id="prcInfo">
		<div class="detail_top">
			...
			<div id="main" class="main" style="display:none">
				...
				<div>
					<div class="date_top" >
						指标日期：<span id="sdate"></span>
					</div>
					<div class="main_con">
						<div class="card">
							<div><span id="m1_return" ></span></div>
							<div>近一月收益率</div>
						</div>
						<div class="card">
				...
				<div>
					<div class="main_con border_none">
						<div class="card2">
							<div>投资顾问：<a id="org_name" data-toggle="popover" data-placement="top" data-trigger="hover"  data-content=""></a></div>
							<div>
								<span><span>成立日期：</span><span id="foundation_date"></span></span>
								<span><span>基金经理：</span><span id="fundManeger"></span></span>
							</div>
						</div>
					</div>
				</div>
			</div>
			<div id="coin"  class="main" style=" margin-top: 20px;display: none;">
				<div style="flex: 3;">
					<div class="main_con">
						<div class="card flex-left">
							<div><span id="nav_date2"></span></div>
							<div>净值日期</div>
						</div>
						<div class="card">
							<div><span id="d7_return_a"></span></div>
							<div>七日年化收益</div>
						</div>
						<div class="card">
							<div><span id="return_10k"></span></div>
							<div>万份收益</div>
						</div>
						<div class="card">
							<div><span id="d7_return_a_rank"></span>/<span id="d7_return_a_rank_total"></span></div>
							<div>七日年化排名</div>
						</div>
						<div class="card">
							<div><span id="foundation_date2"></span></div>
							<div>成立日期</div>
						</div>
					</div>
				</div>
				<div>
					<div class="main_con border_none">
						<div class="card2" style="margin-top: 2px;">
							<div><span style="margin-right: 0;">基金公司名称：</span>
								<a id="org_name2" data-toggle="popover" data-placement="top" data-trigger="hover"  data-content=""></a></div>
							<div style="height: 24px;line-height: 14px;overflow: hidden;">
								<span style="margin-right: 0;">基金经理：</span>
								<span class="ellipse" id="person_name"  data-trigger="hover" data-container="body" data-toggle="popover" data-placement="top" data-content="" style="display: inline-block;color:black;width: calc(82% - 64px);position: relative;top: 3px;">
								</span>
							</div>
						</div>
					</div>
		...
		<div id="Menu" class="detail-menu">
			<ul id="menuUl" style="display: none;">
				...
				<li><a href="#">持仓分析</a></li>
				<li class="nhb" id="menuImg3" data-isLegal="true" ><a href="#">归因分析</a></li>
				<li class="nhb" ><a href="#">情景分析</a></li>
			</ul>
		</div>
	</div>
...
<div class="modal fade" id="mainModal" tabindex="-1" role="dialog"
	 aria-labelledby="myModalLabel" aria-hidden="true">e
...
<script>
    require([ 'easy2/ProductPerspective/publicFunds/publicProDetail' ]);
</script>
</body>
</html>