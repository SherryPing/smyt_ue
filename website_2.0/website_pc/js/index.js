$(function(){
        ...
        if (bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM) {
            window.location.href = "../website_mobile/index.html";
        }
//	导航栏点击
...
//	})
   	 //	各页面导入导航栏和底部
   	 var headerCnt = '<header class="z-header"><nav class="z-header_content"><div class="ico-box"><a href="index.html"  class="ico"></a></div><ul class="menu"><li class="item"><a href="index.html" class="lic nuxt-link-exact-active nuxt-link-active">首页</a></li><li class="item"><span class="lic">核心数据</span><ul><li><a href="hedge.html?name=hedge">中国私募证券投资基金数据库</a></li><li><a href="mutual.html?name=mutual">中国公募基金数据库</a></li></ul></li><li class="item"><span class="lic">系统工具</span><ul><li><a href="fofeasy.html?name=fofeasy">FOF Easy可视化Web终端</a></li><li><a href="fofpower.html">FOF Power基金管理系统</a></li><li><a href="jcc.html">基金查询移动web端—基查查</a></li></ul></li><li class="item"><span class="lic">配套服务</span><ul><li><a href="institution.html">云通致善资产管理研究院</a></li><li><a href="assess.html">评价服务</a></li><li><a href="exponential.html">指数服务</a></li><li><a href="cloudClub.html">云尚俱乐部</a></li></ul></li><li class="item"><a class="lic" href="aboutUs.html">关于我们</a></li></nav></header>'
	$(".header-top").html(headerCnt);
	$(".menu>li").hover(function(e){
		$(this).find("ul").stop().slideToggle()
	})
	var bootCnt = '<div class="footer"><div class="content "><div class="leftCnt "><span class="title">现在注册，即可试用私募云通全线产品</span><div><a href="applyFor.html"><div class="s-btn" style="font-size: 2.2rem;letter-spacing: 2px;">免费注册<img src="img/next.png" style="top: -3px;left: 3px;"/></div></a></div><div style="margin-top:38px; "><div class="phoneimgDiv "><img src="img/phone.png " alt=" "></div><div class="phonetxtDiv "><span>欢迎来电咨询</span><br><span>021-6859-1716</span></div></div></div><div class="rightCnt"><img src="img/code.jpg" alt=""><div>关注私募云通</div></div><hr class="hr1" / style="position:relative;top:36px;"><div class="Copyright"><span>公司地址：上海市浦东新区浦东南路1271-1289号华融大厦901室  |    联系电话：021-6859-1716 （工作日 09:00-18:00） |    客服邮箱：service@fofpower.com</span></div><div class="Copyright2"><span>版权所有 Copyright(©)2016-2018</span><a target="_blank" href="http://www.miitbeian.gov.cn">沪ICP备16034721号-1</a><span>上海琻瑢信息科技有限公司</span></div></div></div>'
	$(".footer-bottom").html(bootCnt);
